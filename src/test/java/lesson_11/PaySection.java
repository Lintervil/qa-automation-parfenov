...
public class PaySection {
    ...
    public void fillFormAndCheckContinueButton() {
        ...
        try {
            ...
            // Используем JavaScript для клика, так как элемент может быть перекрыт
            ...
            // Находим поле для ввода телефона и вводим номер
            ...
            // Находим поле суммы и вводим сумму
            ...
            Assertions.assertTrue(continueButton.isEnabled(),
                    "Кнопка 'Продолжить' должна быть активна (enabled) " +
                            "после ввода номера и суммы");
